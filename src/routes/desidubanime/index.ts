...
desidubRouter.get("/home", async (c) => {
    ...
    try {
        ...
        return c.json({ provider: "Anifire", status: 500, error: "Failed to fetch data" }, 500);
    }
});
...
desidubRouter.get("/search", async (c) => {
    ...
    try {
        ...
        return c.json({ provider: "Anifire", status: 500, error: "Failed to search" }, 500);
    }
});
...
desidubRouter.get("/info/:id", async (c) => {
    ...
    try {
        ...
        return c.json({ provider: "Anifire", status: 500, error: "Failed to fetch info" }, 500);
    }
});
...
desidubRouter.get("/watch/:id", async (c) => {
    ...
    try {
        ...
        return c.json({ provider: "Anifire", status, error: errorMessage.includes("Status 404") ? "Episode not found" : "Failed to fetch stream" }, status);
    }
});
