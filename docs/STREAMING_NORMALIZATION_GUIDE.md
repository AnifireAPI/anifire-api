# AnifireAPI - Streaming Sources Normalization Guide

## Overview

AnifireAPI provides a unified interface to access anime streaming data from multiple sources. This guide explains how to normalize streaming sources and access comprehensive anime information.
...
{
  "streaming": {
    "hianime": "https://api.anifire.me/api/v1/hianime/anime/{mal_id}",
    "animelok": "https://api.anifire.me/api/v1/animelok/anime/{mal_id}",
    "watchanimeworld": "https://api.anifire.me/api/v1/watchanimeworld/anime/{mal_id}",
    "gogoanime": "https://api.anifire.me/api/v1/anime/gogoanime/{title}",
    "allServers": "https://api.anifire.me/api/v1/streaming/{mal_id}"
  }
}
```
        ...
        "anime": [
          {
            ...
            "streaming": {
              "hianime": "https://api.anifire.me/api/v1/hianime/anime/61924",
              "animelok": "https://api.anifire.me/api/v1/animelok/anime/61924",
              "watchanimeworld": "https://api.anifire.me/api/v1/watchanimeworld/anime/61924",
              "gogoanime": "https://api.anifire.me/api/v1/anime/gogoanime/Muzik Tiger In Forest 2nd Season",
              "allServers": "https://api.anifire.me/api/v1/streaming/61924"
            }
          }
        ]
      }
...
curl "https://api.anifire.me/api/v1/hianime/anime/52991"
curl "https://api.anifire.me/api/v1/animelok/anime/52991"
curl "https://api.anifire.me/api/v1/watchanimeworld/anime/52991"
curl "https://api.anifire.me/api/v1/anime/gogoanime/One Piece"
```
